...
bool player_coin_col(bounding_box_t a, bounding_box_t b);
bool player_bar_col(bounding_box_t a, bounding_box_t b);
bool player_boom_col(bounding_box_t a, bounding_box_t b);
bool player_proj_col(bounding_box_t a, bounding_box_t b);
bool player_vis_col(bounding_box_t a, bounding_box_t b);
bool player_snow_col(bounding_box_t a, bounding_box_t b);
bool water_bar_col(bounding_box_t a, bounding_box_t b);
...
extern const color_t COLOR_KNIGHT;
